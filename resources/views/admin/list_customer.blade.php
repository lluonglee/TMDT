    ...
    <div class="col-lg-12">
        <section class="panel">
            <div class="container">
                ...
                <header class="panel-heading">Quản lý tài khoản khách hàng</header>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($cus->status == 1)
                                <form action="{{ url('/customers/lock/'.$cus->customer_id) }}" method="POST"
                                    style="display:inline;">
                                    @csrf
                                    <button type="submit" class="btn btn-warning btn-sm">Khóa</button>
                                </form>
                                @else
                                <form action="{{ url('/customers/unlock/'.$cus->customer_id) }}" method="POST"
                                    style="display:inline;">
                                    @csrf
                                ...
                                <form action="{{ url('/customers/delete/'.$cus->customer_id) }}" method="POST"
