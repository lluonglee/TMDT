...
<body>
    <section id="container">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="username">
                                ...
                                @elseif(Session::has('employee_name'))
        ...
        <!--sidebar start-->
        <aside>
            <div id="sidebar" style="background-color: #5F9EA0;" class="nav-collapse">
                <!-- sidebar menu start-->
                <div class="leftside-navigation">
                    <!-- <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{ url('/add-brand-Product') }}">Thêm thương hiệu sản phâm</a></li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{ url('/add-Product') }}">Thêm sản phâm</a></li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{ url('/employees-create') }}">Tạo tài khoản nhân viên</a></li>
                            </ul>
                            <ul class="sub">
        ...
        <section id="main-content">
            <section class="wrapper" style="background-color: #E0FFFF;">
                @yield('admin_content')
            </section>
            <!-- footer -->
            <!-- <div class="footer">
